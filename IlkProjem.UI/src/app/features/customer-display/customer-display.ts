  ...
  onUpdate() {
    if (this.updateForm.valid && this.selectedCustomerId) {
      ...
      this.customerService.updateCustomer(updatedCustomer).subscribe({
        ...
        error: (err) => this.toastr.error(err.error?.message || this.translate.instant('COMMON.ERROR_GENERIC'), this.translate.instant('TOAST.UPDATE_ERROR'))
      });
    }
  }
  ...
  onCreate() {
    if (this.updateForm.valid) {
      ...
      this.customerService.createCustomer(newCustomer).subscribe({
        ...
        error: (err) => this.toastr.error(err.error?.message || this.translate.instant('COMMON.ERROR_GENERIC'), this.translate.instant('TOAST.ADD_ERROR'))
      });
    }
  }
